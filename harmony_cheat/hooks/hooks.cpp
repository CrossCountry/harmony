		...
		if ( ctx::engine->IsConnected( ) && ctx::engine->IsInGame( ) ) {
			...
			if ( Vars::options.clantag ) {
				...
				if ( int( ctx::globals->curtime ) != iLastTime ) {
					switch ( int( ctx::globals->curtime ) % 10 ) {
						case 0: movement->set_ct( ( "harmony " ) ); break;
						case 1: movement->set_ct( ( "armony  " ) ); break;
						case 2: movement->set_ct( ( "rmony   " ) ); break;
						case 3: movement->set_ct( ( "mony   h" ) ); break;
						case 4: movement->set_ct( ( "ony   ha" ) ); break;
						case 5: movement->set_ct( ( "ny   har" ) ); break;
						case 6: movement->set_ct( ( "y   harm" ) ); break;
						case 7: movement->set_ct( ( "   harmo" ) ); break;
						case 8: movement->set_ct( ( "  harmon" ) ); break;
						case 9: movement->set_ct( ( " harmony" ) ); break;
					}
				}
