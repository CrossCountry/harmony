...
const char* res_type [ ] = { "Default", "Experimental" };
...
const char* key_types [ ] = { "Thirdperson", "Manual AA Left", "Manual AA Right", "Fakewalk"};
...
void aimbot( ) {
	...
	ImGui::Checkbox( "Fake latency (Not Working Atm)", &Vars::options.fakelatency );
...
void misc( ) {
	...
	ImGui::Checkbox( "Harmony Clantag", &Vars::options.clantag );
...
void gui::render( ) {
	...
	if ( Vars::options.menu_open ) { 
		...
		ImGui::Begin( "harmony", &Vars::options.menu_open, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoTitleBar );
